...
namespace CT.MPlus.Editor.BitmapFontCreator
{
    /// <summary>
    /// 位图字体创建，菜单
    /// </summary>
    public class BitmapFontCreaterMenu
    {
        ...
        /// 文件名
        /// </summary>
        [MenuItem("Assets/MPlus/Create Bitmap Font (Direct)/Use「PNG File Name」", false, 0)]
        ...
        /// 直接用当前目录下的资源创建字体
        /// </summary>
        [MenuItem("Assets/MPlus/Create Bitmap Font (Direct)/Use「chars.txt」", false, 0)]
        ...
        /// 直接
        /// </summary>
        [MenuItem("Assets/MPlus/Create Bitmap Font (GUI)", false, 1)]
        ...
        [MenuItem("Tools/MPlus/Create Bitmap Font", false, 1)]
